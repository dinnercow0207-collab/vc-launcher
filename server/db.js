...
async function ensureShopTables() {
  ...
  if (Number(existing.rows[0].c) === 0) {
    ...
    await pool.query(
      `INSERT INTO shop_items (name, description, price, badge, frame_color, theme_bg, tier)
       VALUES ('完成記念ゴールドテーマ', 'このサイトの完成を記念した、金色に輝く最上級の着せ替えテーマ。トーク画面が豪華なゴールドの輝きに包まれ、アイコンの周りもゴールドで縁取られる、特別な存在の証。', 3000, '👑', '#ffd778', 'linear-gradient(160deg, #2a2313, #332a17 40%, #1a1710)', 'legendary')`
    );
  }
  ...
  const renameMap = [
    ...
    ['👑 完成記念クラウン', '完成記念ゴールドテーマ', 'このサイトの完成を記念した、金色に輝く最上級の着せ替えテーマ。トーク画面が豪華なゴールドの輝きに包まれ、アイコンの周りもゴールドで縁取られる、特別な存在の証。', '#ffd778', 'linear-gradient(160deg, #2a2313, #332a17 40%, #1a1710)'],
    ...
    ['完成記念ゴールドリング', '完成記念ゴールドテーマ', 'このサイトの完成を記念した、金色に輝く最上級の着せ替えテーマ。トーク画面が豪華なゴールドの輝きに包まれ、アイコンの周りもゴールドで縁取られる、特別な存在の証。', '#ffd778', 'linear-gradient(160deg, #2a2313, #332a17 40%, #1a1710)'],
  ];
